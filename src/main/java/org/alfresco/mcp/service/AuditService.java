...
public class AuditService {
  ...
  @Tool(
      name = "get_audit_applications",
      description = "Get audit applications and their details from Alfresco Content Service")
  public OperationResponse<Object> getAuditApps() {
    ...
    if (!response.getStatusCode().is2xxSuccessful()) {
      return OperationResponse.builder()
          ...
          .messages(List.of("Error retrieving audit applications: " + response.getStatusCode()))
          .build();
    } else {
    ...
    if (auditAppPaging == null) {
      return OperationResponse.builder()
          .success(false)
          .data(Collections.emptySet())
          .messages(List.of("Error retrieving audit applications: No data found"))
          .build();
    }
    ...
    if (auditAppPagingList == null) {
      return OperationResponse.builder()
          .success(false)
          .data(Collections.emptySet())
          .messages(List.of("Error retrieving audit applications: No list found"))
          .build();
    }
    ...
    if (entries == null || entries.isEmpty()) {
      return OperationResponse.builder()
          .success(false)
          .data(Collections.emptySet())
          .messages(List.of("Error retrieving audit applications: No entries found"))
          .build();
    }

    Set<AuditApp> auditApps = extractAuditApps(entries);

    return OperationResponse.builder().success(true).data(auditApps).build();
  }
  ...
  @Tool(
      ...
      description = "Get the last 100 audit entries for a specific audit application")
  public OperationResponse<Object> getAuditEntries(
      @ToolParam(
              description =
                  "The ID of the audit application. An ID is a string value."
  ...
  @Tool(
      name = "get_x_audit_entries",
      description =
          "Get the x number of audit entries for a specific audit application."
  ...
  public OperationResponse<Object> getXAuditEntries(
      @ToolParam(
              description =
                  "The ID of the audit application. An ID is a string value. The default audit apps for Alfresco are alfresco-access, "
                      + " tagging, and CMISChangeLog. You can also create custom audit applications in Alfresco.")
          String appId,
      @ToolParam(
              description =
                  "The maximum number of audit entries to retrieve. This is a positive integer.")
          int limit) {
    return getXAuditEntriesWhereY(appId, limit, null);
  }

  @Tool(
      name = "get_x_audit_entries_where_y",
      description =
          "Get the x number of audit entries for a specific audit application where y is a specific condition is meet.")
  public OperationResponse<Object> getXAuditEntriesWhereY(
      @ToolParam(
              description =
                  "The ID of the audit application. An ID is a string value. The default audit apps for Alfresco are alfresco-access, tagging, and CMISChangeLog."
                      + " You can also create custom audit applications in Alfresco.")
          String appId,
      @ToolParam(
              description =
      ...
      @ToolParam(
              description =
                  "The condition to filter audit entries by. This is a string value. The format is a where/filter statement between two parentheses."
          ...
          String where) {
    ResponseEntity<AuditEntryPaging> response =
        auditApi.listAuditEntriesForAuditApp(
            appId, 0, Boolean.FALSE, null, limit, where, List.of("values"), null);
    ...
    if (!response.getStatusCode().is2xxSuccessful()) {
      return OperationResponse.builder()
          .success(false)
          .data(Collections.emptySet())
          .messages(List.of("Error retrieving audit entries: " + response.getStatusCode()))
          .build();
    } else {
      log.info(RECEIVED_RESPONSE, response);
    }
    ...
    if (auditEntryPaging == null) {
      return OperationResponse.builder()
          .success(false)
          .data(Collections.emptySet())
          .messages(List.of("Error retrieving audit entries: No response body"))
          .build();
    }
    ...
    if (entries == null || entries.isEmpty()) {
      return OperationResponse.builder()
          .success(false)
          .data(Collections.emptySet())
          .messages(List.of("Error retrieving audit entries: No entries found"))
          .build();
    }

    Set<AuditEntry> auditEntries = extractAuditEntries(entries);

    return OperationResponse.builder().success(true).data(auditEntries).build();
  }
  ...
  @Tool(
      name = "get_audit_entries_for_specific_node",
      description = "Get 100 audit entries for a specific node")
  public OperationResponse<Object> getAuditEntriesForSpecificNode(
      @ToolParam(
              description =
                  "The ID of the node to retrieve audit entries for. This is a string value. The node ID is a unique identifier for a node in Alfresco Content Service. "
  ...
  @Tool(
      name = "get_x_audit_entries_for_specific_node",
      description = "Get x number audit entries for a specific node")
  public OperationResponse<Object> getXAuditEntriesForSpecificNode(
      @ToolParam(
              description =
                  "The ID of the node to retrieve audit entries for. This is a string value. The node ID is a unique identifier for a node in Alfresco Content Service. "
                      + " It follows the format of a UUID, such as '12345678-1234-1234-1234-123456789012'.")
          String nodeId,
      @ToolParam(
              description = "The number of audit entries to retrieve. This is a positive integer.")
          int limit) {
    ResponseEntity<AuditEntryPaging> response =
        auditApi.listAuditEntriesForNode(nodeId, 0, null, limit, null, List.of("values"), null);
